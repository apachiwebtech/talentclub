            ...
            {preview ? null : (
                <div ref={previewRef}>
                    <div className='d-flex justify-content-center'>
                        <div className='' style={{ overflow: 'hidden', background: "#FFC0CB", width: "133.3px", height: "400px" }}>
                            ...
                            <input
                                ...
                                accept="image/*"
                                className=''
                                style={{ width: "133.3px", height: "400px" }}
                            />
                        </div>
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "400px", background: "#B0E0E6" }}>
                        ...
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "400px", background: "#DDA0DD" }}>
