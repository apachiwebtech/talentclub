...
const Frame13 = () => {
    ...
    return (
        <div className='text-center' style={{ position: 'relative', paddingTop: "70px" }}>
            {preview ? null : (
                <div ref={previewRef}>
                    <div className='d-flex justify-content-center'>
                        <div className='' style={{ overflow: 'hidden', background: "#FFC0CB", width: "200px", height: "400px" }}>
                        ...
                        <div className='input2' style={{ overflow: 'hidden', width: "200px", height: "400px", background: "#DDA0DD" }}>
            ...
            {preview ? null : <button className='btn btn-primary' onClick={handleScreenshot}>Preview</button>}
            {preview ? <Link to={`/generatecard/${id}`}><button className='btn btn-primary g-button my-2' onClick={hidediv} >Generate Card</button></Link> : null}
        </div>
    );
};
