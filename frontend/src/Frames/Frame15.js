            ...
            {preview ? null : (
                <div ref={previewRef}>
                    ...
                    <div className='d-flex justify-content-center'>
                        ...
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px" , background : "#FFB6C1"}}>
                        ...
                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px" , background : "#D8BFD8" }}>
                        ...
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px" , background : "#D8BFD8" }}>
