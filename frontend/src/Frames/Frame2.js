            ...
            {preview ? null : (
                <div ref={previewRef}>
                    <div className='d-flex justify-content-center'>
                        <div className='input1' style={{ overflow: 'hidden', background: "#FFC7D1" }}>
                        ...
                        <div>
                            <div className='input2' style={{ overflow: 'hidden', background: "#E1AAE1" }}>
                            ...
                            <div className='input2' style={{ overflow: 'hidden', background: "#B9E4E9" }}>
