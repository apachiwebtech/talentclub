        ...
        <div className='text-center' style={{ position: 'relative', paddingTop : "70px" }}>
            {preview ? null : (
                <div ref={previewRef}>
                    ...
                    <div>
                            <div className='input2' style={{ overflow: 'hidden' , background : "#DDA0DD" }}>
                            ...
                            <div className='input2' style={{ overflow: 'hidden' ,background : "#B0E0E6" }}>
                        ...
                        <div className='input1' style={{ overflow: 'hidden' , background : "#FFC0CB" }}>
