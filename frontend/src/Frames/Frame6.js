            ...
            {preview ? null : (
                <div ref={previewRef}>
                    <div className='d-flex justify-content-center'>
                        <div>
                            <div className='input2' style={{ overflow: 'hidden', width: "266.6px", height: "266.6px", background: "#FFC0CB" }}>
                        ...
                        <div>
                            <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#ADD8E6" }}>
                            ...
                            <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#DDA0DD" }}>
                    ...
                    <div className='d-flex justify-content-center'>
                        <div className='input1' style={{ overflow: 'hidden', width: "200px", height: "133.3px", background: "#DDA0DD" }}>
                            ...
                            <input
                                ...
                                accept="image/*"
                                className='input1'
                                style={{ width: "200px", height: "133.3px" }}
                            />
                        </div>
                        <div className='input1' style={{ overflow: 'hidden', width: "200px", height: "133.3px", background: "#ADD8E6" }}>
