        ...
        <div className='text-center' style={{ position: 'relative', paddingTop: "70px" }}>
            {preview ? null : (
                <div ref={previewRef}>
                    ...
                    <div className='d-flex justify-content-center'>
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "200px", background: "#FFA07A" }}>
                            ...
                            <input
                                ...
                                accept="image/*"
                                className='input2'
                                style={{ width: "133.3px", height: "200px" }}
                            />
                        </div>
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "200px", background: "#B0E0E6" }}>
                        ...
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "200px", background: "#DDA0DD" }}>
