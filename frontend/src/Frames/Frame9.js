...
const Frame9 = () => {
    ...
    const [position7, setPosition7] = useState({ x: 0, y: 0 });
    const [position8, setPosition8] = useState({ x: 0, y: 0 });
    ...
    const handleFileChange7 = (event, index) => {
        ...
        if (file) {
            ...
            reader.onload = () => {
                const updatedFiles = [...selectedFiles7];
                updatedFiles[index] = {
                    file,
                    previewURL: reader.result,
                    // Set your actual image height
    ...
    const handleFileChange8 = (event, index) => {
        ...
        if (file) {
            ...
            reader.onload = () => {
                const updatedFiles = [...selectedFiles8];
                updatedFiles[index] = {
                    file,
                    previewURL: reader.result,
                    // Set your actual image height
    ...
    const handleFileChange9 = (event, index) => {
        const file = event.target.files[0];
        ...
        if (file) {
            ...
            reader.onload = () => {
                const updatedFiles = [...selectedFiles9];
                updatedFiles[index] = {
                    file,
                    previewURL: reader.result,
                    // Set your actual image height
            ...
            {preview ? null : (
                <div ref={previewRef}>
                    <div className='d-flex justify-content-center'>
                        ...
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#FFC0CB" }}>
                            ...
                            <input
                                ...
                                accept="image/*"
                                className='input2'
                                style={{ width: "133.3px", height: "133.3px" }}
                            />
                        </div>



                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#DDA0DD" }}>
                        ...
                        <div className='input2' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#B0E0E6" }}>
                    ...
                    <div className='d-flex justify-content-center'>
                        ...
                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#FFA07A" }}>
                        ...
                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#B0E0E6" }}>
                        ...
                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#FFC0CB" }}>
                        ...
                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#B0E0E6" }}>
                            {selectedFiles7.map((file, index) => (
                                <Draggable
                                    key={index}
                                    position={position6}
                                    onStop={(e, data) => setPosition6({ x: data.x, y: data.y })}
                                >
                                    <div className="frame-prev" style={{ position: 'relative' }}>
                                        <img
                                            src={file.previewURL}
                            ...
                            <input
                                type="file"
                                onChange={(e) => handleFileChange7(e, 0)}
                                accept="image/*"
                                className='input1'
                                style={{ width: "133.3px", height: "133.3px" }}
                            />
                        ...
                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#FFC0CB" }}>
                            {selectedFiles8.map((file, index) => (
                                <Draggable
                                    key={index}
                                    position={position7}
                                    onStop={(e, data) => setPosition7({ x: data.x, y: data.y })}
                                >
                                    <div className="frame-prev" style={{ position: 'relative' }}>
                                        <img
                                            src={file.previewURL}
                            ...
                            <input
                                type="file"
                                onChange={(e) => handleFileChange8(e, 0)}
                                accept="image/*"
                                className='input1'
                                style={{ width: "133.3px", height: "133.3px" }}
                            />
                        ...
                        <div className='input1' style={{ overflow: 'hidden', width: "133.3px", height: "133.3px", background: "#FFA07A" }}>
                            {selectedFiles9.map((file, index) => (
                                <Draggable
                                    key={index}
                                    position={position8}
                                    onStop={(e, data) => setPosition8({ x: data.x, y: data.y })}
                                >
                                    <div className="frame-prev" style={{ position: 'relative' }}>
                                        <img
                                            src={file.previewURL}
                            ...
                            <input
                                type="file"
                                onChange={(e) => handleFileChange9(e, 0)}
                                accept="image/*"
                                className='input1'
                                style={{ width: "133.3px", height: "133.3px" }}
